...
class PDFMaker_ValidateExpression_Action extends Vtiger_Action_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->exposeMethod('ForPDFMakerDisplayEdit');
    }
    ...
    public function ForPDFMakerDisplayEdit(Vtiger_Request $request)
    {
