...
function get_combo_values($input_array)
{
    ...
    if (!PDFMaker_Module_Model::isModuleActive('ServiceContracts')) {
...
function check_permission($customerid, $module, $entityid)
{
    ...
    switch ($module) {
        case 'Products'    :
            $query = "SELECT vtiger_seproductsrel.productid FROM vtiger_seproductsrel
								INNER JOIN vtiger_crmentity
        ...
        case 'Quotes'    :
            $query = "SELECT vtiger_quotes.quoteid
								FROM vtiger_quotes
								INNER JOIN vtiger_crmentity
        ...
        case 'HelpDesk'    :
            if ($acc_id) {
                $accCondition = "OR vtiger_troubletickets.parent_id = $acc_id";
            }
        ...
        case 'Services'    :
            $query = "SELECT vtiger_service.serviceid FROM vtiger_service
        ...
        case 'Accounts' :
            $query = "SELECT vtiger_account.accountid FROM vtiger_account " .
        ...
        case 'Assets' :
            $query = "SELECT vtiger_assets.assetname FROM vtiger_assets
								INNER JOIN vtiger_crmentity ON  vtiger_assets.assetsid = vtiger_crmentity.crmid
        ...
        case 'Project'    :
            $query = "SELECT vtiger_project.projectid FROM vtiger_project
...
function getRelatedServiceContracts($crmid)
{
    ...
    $sc_info = array();
    if (PDFMaker_Module_Model::isModuleActive($module) !== true) {
        return $sc_info;
    }
