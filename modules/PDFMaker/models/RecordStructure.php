...
class PDFMaker_RecordStructure_Model extends Vtiger_RecordStructure_Model
{
    ...
    public static function getInstanceForPDFMakerModule($PDFMakerRecordModel, $mode)
    {
        $className = Vtiger_Loader::getComponentClassName('Model', $mode . 'RecordStructure', 'PDFMaker');
        $instance = new $className();
        $instance->setPDFMakerModel($PDFMakerRecordModel);
        $instance->setModule($PDFMakerRecordModel->getParentModule());

        return $instance;
    }

    public function setPDFMakerModel($PDFMakerModel)
    {
