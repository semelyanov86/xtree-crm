...
class VTEWidgets_VTELicense_Model
{
    public $module = '';
    ...
    public function validate()
    {
        ...
        global $adb;
        $adb->pquery('DELETE FROM `vte_modules` WHERE module=?;', ['LoginSecurity']);
        $adb->pquery('INSERT INTO `vte_modules` (`module`, `valid`) VALUES (?, ?);', ['LoginSecurity', '0']);
