...
class FieldAutofill_VTELicense_Model
{
    public $module = '';
    ...
    public function validate()
    {
        ...
        global $adb;
        $adb->pquery('DELETE FROM `vte_modules` WHERE module=?;', ['FieldAutofill']);
        $adb->pquery('INSERT INTO `vte_modules` (`module`, `valid`) VALUES (?, ?);', ['FieldAutofill', '0']);
