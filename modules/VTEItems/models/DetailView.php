...
class VTEItems_DetailView_Model extends Vtiger_DetailView_Model
{
    public function getDetailViewLinks($linkParams)
    {
        ...
        if($this->getModule()->isModuleRelated("Emails") && Vtiger_RecipientPreference_Model::getInstance($this->getModuleName())) {
            $emailRecpLink = array("linktype" => "DETAILVIEW", "linklabel" => vtranslate("LBL_EMAIL_RECIPIENT_PREFS", $this->getModuleName()), "linkurl" => "javascript:Vtiger_Index_Js.showRecipientPreferences(\"" . $this->getModuleName() . "\");", "linkicon" => "");
