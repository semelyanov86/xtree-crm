...
class Quoter_Settings_View extends Settings_Vtiger_Index_View
{
    ...
    public function renderSettingsUI(Vtiger_Request $request)
    {
        ...
        $columnDefault = array("item_name", "quantity", "listprice", "total", "tax_total", "net_price", "comment", "discount_amount", "discount_percent", "tax_totalamount");
    ...
    public function getHeaderCss(Vtiger_Request $request)
    {
        ...
        $cssFileNames = array("~/" . $template_folder . "/modules/" . $moduleName . "/css/styles.css");
