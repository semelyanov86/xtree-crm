...
Vtiger.Class("Payments_Edit_Js", {}, {
    ...
    setReferenceFieldValue : function(container, params) {
        ...
        // Auto fill Account, Contact when user select Potential for Payment
        if(sourceField=='potential' && popupReferenceModule=='Potentials' && app.getModuleName()=='VTEPayments'){
            jQuery.ajax({
                url: 'index.php?module=VTEPayments&mode=getPotentialData&id='+id,
                data: {action:'Ajax'},
                type: 'POST',
                success: function(dataresponse) {
                    var invoiceData =JSON.parse(dataresponse.result);
