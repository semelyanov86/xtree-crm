...
<div class="popupUi modal hide" data-backdrop="false" style="z-index: 1000006;min-width: 750px;overflow: visible">
	...
	<div class="modal-body">
		<div class="row">
			...
			<span class="col-lg-4 hide useFieldContainer">
				<span name="{$MODULE_MODEL->get('name')}" class="useFieldElement">
					{assign var=MODULE_FIELDS value=$MODULE_MODEL->getFields()}
					<select class="useField select2" data-placeholder="{vtranslate('LBL_USE_FIELD',$QUALIFIED_MODULE)}">
						<option></option>
						<optgroup>
			...
			<span class="col-lg-4 hide useFunctionContainer">
				<select class="useFunction select2" data-placeholder="{vtranslate('LBL_USE_FUNCTION',$QUALIFIED_MODULE)}">
					<option></option>
					<optgroup>
