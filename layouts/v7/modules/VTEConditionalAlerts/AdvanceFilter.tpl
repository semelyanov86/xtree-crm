...
<div class="filterContainer filterElements well filterConditionContainer filterConditionsDiv conditionGroup" style="border: none;">
    ...
    <input type=hidden id="roles" data-value='{ZEND_JSON::encode($ROLES)}' />
	<div class="filterContainer filterElements well filterConditionContainer filterConditionsDiv conditionGroup">
		<div class="header">
		...
		<div class="contents">
			...
			<div class="addConditionClf">
				<button type="button" class="btn btn-default btnAddConditionClf"><strong>{vtranslate('LBL_ADD_CONDITION',$MODULE)}</strong></button>
			</div>
