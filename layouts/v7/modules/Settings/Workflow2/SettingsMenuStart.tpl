...
<div class="main-container clearfix">
    ...
    <div class="module-nav clearfix settingsNav" id="modnavigator">
        <div class="hidden-xs hidden-sm height100Per">
            {if $MODE eq 'Overview'}
                {include file="modules/Settings/Workflow2/VT7/Sidebar.tpl"}
            {/if}
            {if $MODE eq 'Config'}
                {include file="modules/Settings/Workflow2/VT7/SidebarConfig.tpl"}
            {/if}
            {if $MODE eq 'Statistic'}
                {include file="modules/Settings/Workflow2/VT7/SidebarStatistic.tpl"}
            {/if}
        </div>
    </div>
