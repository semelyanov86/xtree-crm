                                        ...
                                        <div class="col-lg-12 col-md-12 col-lg-pull-0">
                                            <h4>{vtranslate('LBL_DISPLAYED',$MODULE)}:
                                                <select id="displayedValue" name="displayedValue" class="select2">
                                                    <option value="0" {if $PDF_TEMPLATE_RESULT.displayed eq "0"}selected{/if}>{vtranslate('LBL_YES',$MODULE)}</option>
                                                    <option value="1" {if $PDF_TEMPLATE_RESULT.displayed eq "1"}selected{/if}>{vtranslate('LBL_NO',$MODULE)}</option>
                                                </select>
