    ...
    <div class="row-fluid">
        ...
        <div class="row-fluid">
            <div class="pull-right btn-group">
                <button type="button" class="addProductBlock btn addButton btn-default ProductBlockBtn" data-url="?module=PDFMaker&view=EditProductBlock"><i class="icon-plus icon-white"></i>&nbsp;<strong> {vtranslate('LBL_ADD')}</strong></button>
                ...
                <tr class="opacity">
                    ...
                    <td style="border-left: none;">
                        <div class="pull-right actions">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default editProductBlock ProductBlockBtn" data-url="index.php?module=PDFMaker&view=EditProductBlock&tplid={$tpl_id}" data-tplid="{$tpl_id}">
                                ...
                                <button type="button" class="btn btn-danger ProductBlockBtn" data-url="index.php?module=PDFMaker&action=IndexAjax&mode=DeleteProductBlock&tplid={$tpl_id}" data-tplid="{$tpl_id}">
        ...
        <div class="row-fluid pushDownHalfper">    
            <div class="pull-right btn-group">
                <button type="button" class="addProductBlock btn btn-default addButton ProductBlockBtn" data-url="index.php?module=PDFMaker&view=EditProductBlock"><i class="icon-plus icon-white"></i>&nbsp;<strong> {vtranslate('LBL_ADD')}</strong></button>
                <button type="reset" class="btn btn-default" onClick="window.history.back();">{vtranslate('LBL_CANCEL')}</button>
            </div>  
        </div>
    </div>
