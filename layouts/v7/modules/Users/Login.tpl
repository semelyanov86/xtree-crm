...
{strip}
    ...
    <div class="vte-login-container">
        <div class="logo">
            <img src="test/logo/thumbnail_xtree_logo_150x40.png" />
        </div>
        <div style="margin-left: -10px">
                    ...
                    <ul class="bxslider">
                        <li>
                                <div id="slide0" class="slide">
                                    <img class="pull-left" src="test/logo/Banner2.png">
                                </div>
                            </li><li>
                                <div id="slide1" class="slide">
                                    <img class="pull-left" src="test/logo/Banner 3.png">
                                </div>
                            </li><li>
                                <div id="slide2" class="slide">
                                    <img class="pull-left" src="test/logo/x2tree_visual_teal.PNG">
                                </div>
                            </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 login-area">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 site-info">
                    <h1 class="login-header">X2TREE CRM</h1>
                    <p>Be easy! Be productive</p>
                </div>
