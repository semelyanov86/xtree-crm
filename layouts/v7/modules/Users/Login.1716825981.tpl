...
{strip}
    ...
    <div class="vte-login-container">
        <div class="logo">
            <img src="test/logo/x2tree-logo.jpg" />
        </div>
                    ...
                    <ul class="bxslider">
                        <li>
                                <div id="slide0" class="slide">
                                    <img class="pull-left" src="test/logo/x2tree1.jpg">
                                </div>
                            </li><li>
                                <div id="slide1" class="slide">
                                    <img class="pull-left" src="test/logo/x2tree2.jpg">
                                </div>
                            </li><li>
                                <div id="slide2" class="slide">
                                    <img class="pull-left" src="test/logo/x2tree3.jpg">
                                </div>
                            </li>
                    </ul>
                </div>
