            ...
            <div class="contents">
                <div class="conditionList">
                    {foreach item=CONDITION_INFO from=$ALL_CONDITION_CRITERIA['columns']}
                        {include file=vtemplate_path('AdvanceFilterCondition.tpl','VTEButtons') QUALIFIED_MODULE=$QUALIFIED_MODULE RECORD_STRUCTURE=$RECORD_STRUCTURE CONDITION_INFO=$CONDITION_INFO MODULE=$MODULE}
                    {/foreach}
                    {if count($ALL_CONDITION_CRITERIA) eq 0}
                        {include file=vtemplate_path('AdvanceFilterCondition.tpl','VTEButtons') QUALIFIED_MODULE=$QUALIFIED_MODULE RECORD_STRUCTURE=$RECORD_STRUCTURE MODULE=$MODULE CONDITION_INFO=array()}
                    {/if}
                </div>
                <div class="hide basic">
                    {include file=vtemplate_path('AdvanceFilterCondition.tpl','VTEButtons') QUALIFIED_MODULE=$QUALIFIED_MODULE RECORD_STRUCTURE=$RECORD_STRUCTURE CONDITION_INFO=array() MODULE=$MODULE NOCHOSEN=true}
                </div>
            ...
            <div class="contents">
                <div class="conditionList">
                    {foreach item=CONDITION_INFO from=$ANY_CONDITION_CRITERIA['columns']}
                        {include file=vtemplate_path('AdvanceFilterCondition.tpl','VTEButtons') QUALIFIED_MODULE=$QUALIFIED_MODULE RECORD_STRUCTURE=$RECORD_STRUCTURE CONDITION_INFO=$CONDITION_INFO MODULE=$MODULE CONDITION="or"}
                    {/foreach}
                    {if count($ANY_CONDITION_CRITERIA) eq 0}
                        {include file=vtemplate_path('AdvanceFilterCondition.tpl','VTEButtons') QUALIFIED_MODULE=$QUALIFIED_MODULE RECORD_STRUCTURE=$RECORD_STRUCTURE MODULE=$MODULE CONDITION_INFO=array() CONDITION="or"}
                    {/if}
                </div>
                <div class="hide basic">
                    {include file=vtemplate_path('AdvanceFilterCondition.tpl','VTEButtons') QUALIFIED_MODULE=$QUALIFIED_MODULE RECORD_STRUCTURE=$RECORD_STRUCTURE MODULE=$MODULE CONDITION_INFO=array() CONDITION="or" NOCHOSEN=true}
                </div>
                <div class="addCondition">
                    <button type="button" class="btn  btn-default"><i class="fa fa-plus"></i>&nbsp;&nbsp;{vtranslate('LBL_ADD_CONDITION',$MODULE)}</button>
                </div>
