    ...
    <form name="EditWorkflow" action="index.php" method="post" id="clf_step3" class="form-horizontal">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                <li>
                    <a data-url="?module=VTEConditionalAlerts&parent=Settings&view=EditTask&selected_module={$SELECTED_MODULE}&cat_id={$RECORD}" class="cursorPointer">Update Fields</a>
                </li>
            </ul>
        </div>
