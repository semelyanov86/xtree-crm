...
VTEConditionalAlerts_Edit_Js("VTEConditionalAlerts_Edit2_Js",{},{
    ...
    registerFormSubmit: function(){
        var thisInstance = this;
        var form_step2 = jQuery('.controlLayoutFieldsContents').find('form');
        form_step2.on('submit',function(e){
            ...
            AppConnector.request(formData).then(
                function(data) {
                    if(data.result) {
                        Settings_Vtiger_Index_Js.showMessage({text : app.vtranslate('Conditional Alerts/Popups had been saved successfully')});
                        ...
                        var params = {
                            ...
                            view : 'Edit',
                            mode : 'Step3',
                            selected_module : data.result.selected_module,
            ...
            AppConnector.request(actionParams).then(
                function(data) {
                    if(data) {
                        ...
                        app.changeSelectElementView(jQuery('.controlLayoutFieldsContents'));
