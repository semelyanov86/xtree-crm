...
{strip}
<select class="{if empty($BASE)}chzn-select{/if}" required="true"  {if $IS_DEFAULT eq 1} disabled="disabled" {/if} data-validation-engine="validate[required]"  style="width: 100%;">
