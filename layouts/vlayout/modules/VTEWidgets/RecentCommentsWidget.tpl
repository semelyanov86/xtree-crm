...
{strip}
    ...
    <div class="commentContainer recentComments">
                                    ...
                                    <div class="row-fluid">
                                        <div class="pull-right commentActions">
											...
											{if $PARENT_COMMENT_MODEL neq false or $CHILD_COMMENTS_MODEL neq null}
												...
												<a href="javascript:void(0);" class="cursorPointer detailViewThreadWidget">{vtranslate('LBL_VIEW_THREAD',$MODULE_NAME)}</a>
                                            {/if}
										</span>
                                        </div>
                                    </div>
        ...
        {/if}
        <div class="hide basicAddCommentBlockWidget">
            <div class="row-fluid">
            ...
            <div class="pull-right">
                <button class="btn btn-success widgetSaveComment" type="button" data-mode="add"><strong>{vtranslate('LBL_POST', $MODULE_NAME)}</strong></button>
                <a class="cursorPointer closeCommentBlockWidget cancelLink" type="reset">{vtranslate('LBL_CANCEL', $MODULE_NAME)}</a>
            </div>
        </div>
        <div class="hide basicEditCommentBlockWidget" style="min-height: 150px;">
            <div class="row-fluid">
                <span class="span1">&nbsp;</span>
                <div class="span11">
            ...
            <div class="pull-right">
                <button class="btn btn-success widgetSaveComment" type="button" data-mode="edit"><strong>{vtranslate('LBL_POST', $MODULE_NAME)}</strong></button>
                <a class="cursorPointer closeCommentBlockWidget cancelLink" type="reset">{vtranslate('LBL_CANCEL', $MODULE_NAME)}</a>
            </div>
        </div>
    </div>
