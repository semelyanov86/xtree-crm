                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="{$WIDTHTYPE}" style="border-left: none;">
                                <input type="text" name="header" class="input-xxlarge" data-validation-engine='validate[required]' value="{$ENTITY.header}" />
                            </td>
                        </tr>
                        <tr>
                            <td width="20%" class="{$WIDTHTYPE}" style="vertical-align: middle;">
                        ...
                        <tr>
                            ...
                            <td class="{$WIDTHTYPE}" style="border-left: none;">
                                <input type="text" class="input-xxlarge" name="copyright"  value="{$ENTITY.copyright}" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            ...
                            <td class="{$WIDTHTYPE}" style="border-left: none;">
                                <select name="slide_type" class="chzn-select">
                        ...
                        <tr>
                            ...
                            <td class="{$WIDTHTYPE}" style="border-left: none;">
                                <input type="text" name="slide_speed" value="{if $ENTITY.slide_speed eq ''}1500{else}{$ENTITY.slide_speed}{/if}"/>
                            </td>
                        </tr>
                        <tr>
                            <td width="20%" class="{$WIDTHTYPE}" style="vertical-align: middle;">
                            ...
                            <td class="{$WIDTHTYPE}" style="border-left: none;">
                                <select name="slide_easing" class="chzn-select">
                        ...
                        <tr>
                            ...
                            <td class="{$WIDTHTYPE}" style="border-left: none;">
                                <input type="text" name="social_facebook" value="{$ENTITY.social_facebook}" />
                            </td>
                        </tr>
                        <tr>
                            <td width="20%" class="{$WIDTHTYPE}" style="vertical-align: middle;">
                            ...
                            <td class="{$WIDTHTYPE}" style="border-left: none;">
                                <input type="text" name="social_twitter" value="{$ENTITY.social_twitter}" />
                            </td>
                        </tr>
                        <tr>
                            <td width="20%" class="{$WIDTHTYPE}" style="vertical-align: middle;">
                            ...
                            <td class="{$WIDTHTYPE}" style="border-left: none;">
                                <input type="text" name="social_linkedin" value="{$ENTITY.social_linkedin}" />
                            </td>
                        </tr>
                        <tr>
                            <td width="20%" class="{$WIDTHTYPE}" style="vertical-align: middle;">
                            ...
                            <td class="{$WIDTHTYPE}" style="border-left: none;">
                                <input type="text" name="social_youtube" value="{$ENTITY.social_youtube}" />
                            </td>
                        </tr>
                    </tbody>
                </table>
