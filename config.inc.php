...
/*\Sentry\init([
    ...
    'profiles_sample_rate' => (float) getenv('SENTRY_PROFILES_SAMPLE_RATE'),
]);*/
...
$HELPDESK_SUPPORT_EMAIL_ID = 'se@sergeyem.ru';
...
$application_unique_key = '5b0e6576cacd773f9a4853f3088020fb';
