...
$languageStrings = [
    ...
    'Do not open a Workflow with IE < 9!' => 'Do not open a Workflow with IE &lt; 9!',
    ...
    'LBL_BEFORE_SAVE_TRIGGER' => 'start before record save',
    'HEAD_DEFAULT_IMPORT_CONFIGURATION' => 'default Import settings',
    'LBL_DEFAULT_DELIMITER' => 'default CSV data delimiter',
    'LBL_DEFAULT_SKIP_FIRST_ROW' => 'skip first row (headline)',
    'LBL_DEFAULT_ENCODING' => 'default file encoding',
];
